                    ...
                    <div class="col-md-12">
                        <article class="entry">
                            <div class="feature-post">
                                <img src="{{ $agendapost->ImageTumb }}" alt="image">
                            </div><!-- /.feature-post -->
                            <div class="main-post">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <h2 class="title-post"><a href="#">{{ $agendapost->title }}</a></h2>
                                        <div class="meta-post clearfix">
                                            <ul>            
                                                <li class="fa fa-calendar"><a href="#">{{ $agendapost->lokasi }}</a></li>
                                                <li class="fa fa-calendar"><a href="#">{{ $agendapost->FinishAdmin }}</a></li>-
                                                <li class="fa fa-location-arrow"><a href="#">{{ $agendapost->StartAdmin }}</a></li>
                                            </ul>
                                        </div><!-- /.meta-post -->
                                        <div class="desc">
                                            <p>descripsion</p>
