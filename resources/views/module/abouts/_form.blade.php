<div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		{!! Form::select('title', ['1' => 'visi', '2' => 'misi', '3'=> 'sejarah'],null, ['placeholder' => 'Pilih Title', 'class' => 'form-control col-md-7 col-xs-12']) !!}
		...
		@if (isset($abouts) && $abouts->image !== '') 
				<div class="row">
    				<div class="col-md-6">
    					<br><br>
    					<div class="thumbnail">
							<img src="{{ url($abouts->ImagePath) }}" class="img-rounded"> 
						</div>
    				</div>
  				</div>
			@endif
