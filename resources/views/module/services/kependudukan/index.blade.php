                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                       <a href="{{ route('kependudukan.create') }}"><button class="btn btn-primary btn-md">Tambah</button></a>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            ...
                            {!! Form::open(['route' => ['kependudukan.destroy', $lay->id], 'method' => 'DELETE']) !!}

                            @can('edit_berita')
                            <a href="{{ route ('kependudukan.edit',$lay->id) }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            @endcan
